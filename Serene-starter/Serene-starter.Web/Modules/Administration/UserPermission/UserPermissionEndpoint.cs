using MyRepository = Serene_starter.Administration.Repositories.UserPermissionRepository;
using MyRow = Serene_starter.Administration.UserPermissionRow;

namespace Serene_starter.Administration.Endpoints;
