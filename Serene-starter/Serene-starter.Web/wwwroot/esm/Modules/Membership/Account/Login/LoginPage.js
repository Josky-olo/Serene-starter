import{a as u}from"../../../../_chunks/chunk-VPZFL5QW.js";import{a as s}from"../../../../_chunks/chunk-FLH26EPL.js";import{a as l,b as d,e as c}from"../../../../_chunks/chunk-VVOU4364.js";var m=d(c(),1),e=d(c(),1);$(function(){var n,r,o;var i=new a($("#LoginPanel")).init();i.element.find(".forgot-password").appendTo(".field.Password"),(n=document.getElementById("IsPublicDemo"))!=null&&n.value&&(i.byId("Username").val("admin").attr("placeholder","admin"),i.byId("Password").val("serenity").attr("placeholder","serenity")),(r=document.getElementById("Activated"))!=null&&r.value&&(i.byId("Username").val((o=document.getElementById("Activated"))==null?void 0:o.value),i.byId("Password").focus())});var a=class extends m.PropertyPanel{getFormKey(){return u.formKey}constructor(n){super(n),this.byId("LoginButton").click(r=>{if(r.preventDefault(),!!this.validateForm()){var o=this.getSaveEntity();(0,e.serviceCall)({url:(0,e.resolveUrl)("~/Account/Login"),request:o,onSuccess:()=>{this.redirectToReturnUrl()},onError:t=>{if(t!=null&&t.Error!=null&&t.Error.Code=="RedirectUserTo"){window.location.href=t.Error.Arguments;return}if(t!=null&&t.Error!=null&&!(0,e.isEmptyOrNull)(t.Error.Message)){(0,e.notifyError)(t.Error.Message),$("#Password").focus();return}e.ErrorHandling.showServiceError(t.Error)}})}})}redirectToReturnUrl(){var n=(0,e.parseQueryString)(),r=n.returnUrl||n.ReturnUrl;if(r&&/^\//.test(r)){var o=window.location.hash;o!=null&&o!="#"&&(r+=o),window.location.href=r}else window.location.href=(0,e.resolveUrl)("~/")}getTemplate(){return`
<h2 class="text-center p-4">
    <img src="${(0,e.resolveUrl)("~/Content/site/images/serenity-logo-w-128.png")}"
        class="rounded-circle p-1" style="background-color: var(--s-sidebar-band-bg)"
        width="50" height="50" /> Serene_starter
</h2>
